...
export ZSH=/Users/stevennatera/.oh-my-zsh
...
alias terminate='stripe=$(lsof -t -i:4999); mail=$(lsof -t -i:1025); server=$(cat /Users/stevennatera/work/harrys/tmp/pids/server.pid); kill $stripe $mail $server;'
